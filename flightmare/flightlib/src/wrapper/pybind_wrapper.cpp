...
PYBIND11_MODULE(flightgym, m) {
  py::class_<VecEnv<QuadrotorEnv>>(m, "QuadrotorEnv_v1")
    ...
    .def("seedDisturbance", &VecEnv<QuadrotorEnv>::seedDisturbance)
    ...
    .def("getObs", &VecEnv<QuadrotorEnv>::getObs)
    .def("setEnvMasses", &VecEnv<QuadrotorEnv>::setEnvMasses)
    ...
    .def("setDisturbanceParams", &VecEnv<QuadrotorEnv>::setDisturbanceParams)
