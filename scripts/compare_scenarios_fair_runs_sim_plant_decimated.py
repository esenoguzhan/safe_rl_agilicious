...
This is a decimated variant of:
  scripts/compare_scenarios_fair_runs_sim_plant.py
...
import scripts.compare_scenarios_fair_runs_sim_plant as sim_plant
from scripts.train_v3_decimated_physics import VecPhysicsDecimationWrapper
...
def _patch_compare_env_build_for_decimation(
    ...
    """Temporarily patch compare_scenarios env build to use decimated timing."""
...
def main() -> None:
    ...
    with open(log_path, "w") as f:
        f.write("compare_scenarios_fair_runs_sim_plant_decimated log\n")
